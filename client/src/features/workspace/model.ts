...
export const BackendRelation = Schema.Struct({
  ...
  fds: Schema.Array(
    Schema.Struct({ lhs: Schema.Array(Schema.String), rhs: Schema.Array(Schema.String) })
  ),
});
...
export const BackendTreeNode: Schema.Schema<any> = Schema.suspend(() =>
  Schema.Struct({
    tnRelation: BackendRelation,
    tnSplitFD: Schema.Option(
      Schema.Struct({ lhs: Schema.Array(Schema.String), rhs: Schema.Array(Schema.String) })
    ),
