                ...
                <div className="flex flex-wrap gap-1">
                    {attributes.map((attr) => (
                        <Badge
                            key={attr}
                            variant="outline"
                            className={`cursor-pointer hover:bg-slate-200 ${rhs.has(attr)
        ...
        >
            ...
            >
                    ...
                    <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            {data.health && data.health.severity !== "ok" && (
                                ...
                                >
                                    {data.health.severity === "error" ? "⚠ Critical" : data.health.message?.includes("3NF") ? "ℹ 3NF" : "⚡ Warning"}
                                </Badge>
                            )}
                        </div>
                ...
                <CardContent className="p-2">
                    ...
                    {/* Health Message */}
                    {data.health && (data.health.severity !== "ok" || data.health.message.includes("BCNF")) && (
                        <div
                        ...
                        >
                            <span className="font-medium">
                                {data.health.severity === "error" ? "⚠️ " : data.health.severity === "warning" ? (data.health.message.includes("3NF") ? "ℹ️ " : "⚡ ") : "✅ "}
                            </span>
                            {data.health.message}
                            {data.health.severity !== "ok" && !data.health.message.includes("BCNF") && (
                                <div className="mt-1 font-semibold hover:underline cursor-pointer" onClick={data.onOptimize}>
                                    👉 Click ⚙ to optimize
                                </div>
                            )}
                        </div>
